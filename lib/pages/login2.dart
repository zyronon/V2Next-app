...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    super.initState();
    getSignKey();
    _userNameController.text = 'shzbkzo';
    _passwordController.text = 'o894948816O!';
              ...
              children: <Widget>[
                ...
                Container(
                    ...
                    child: TDButton(
                      ...
                      onTap: () async {
                        // if (loadingCodeImg || _code!.isEmpty) {
                        //   Utils.toast(msg: '请输入正确的验证码');
                        //   return;
                        // }
                        ...
                        //   loadingLogin = true;
                        // });
                        // var result = await Api.onLogin(loginKey);
                        // setState(() {
                        //   loadingLogin = false;
                        // });
                        // if (result == 'true') {
                        ...
                        if ((_formKey.currentState as FormState).validate()) {
                          ...
                          loginKey.passwordValue = _passwordController.text;
                          loginKey.codeValue = _codeController.text;
                          // 键盘收起
